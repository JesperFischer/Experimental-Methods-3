...
Looking at the scatter plot there doesn't seem to be any real outliers.
...
There was a significantly difference between ASD and TD in MLU B = 0.6472, se = 0.1636, t(58.8417) = 3.957, p<0.01
when the visit number increases linearly the MLU increases significantly aswell B=3.31, se = 0.6438 t(287.22) = 5.14, p < 0.01
when the visit number increases quadraticly  the MLU decreases significantly B=-1.3, se = 0.64 t(287.24) = -2.1, p < 0.05
furthermore there was a interaction effect between diagnosis and visit (linearly) B=8.2 se = 0.89 t(287.27) = 9.2 p < 0.01


- A plain word description of the results

TD has longer length of utterances compared to ASD on average 0.6 longer utterances. The cildren's MLU increase as time passes linearly, however it seems to be the case that this linear increase decreases over time (it becomes less steep). The interaction effect shows that there is a difference in how much the MLU changes over time in the two groups. (see plot 1)

```{r}
#interaction effct modeled.
...
Parent MLU is affected by Diagnosis B = 0.364, se = 0.15 t(147) = 2.44 p < 0.05 and visist B = 0.098, se = 0.20, t(289.6) = 5, p < 0.01
